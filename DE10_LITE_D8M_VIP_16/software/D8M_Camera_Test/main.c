...
void mipi_show_error_info(void) {
  ...
  printf("PHY_status=%xh, CSI_status=%xh, MDLSynErr=%xh, FrmErrCnt=%xh, "
         "MDLErrCnt=%xh\r\n",
...
bool MIPI_Init(void) {
  ...
  //	bSuccess = oc_i2c_init_ex(I2C_OPENCORES_CAMERA_BASE,
  // 50*1000*1000,400*1000); //I2C: 400K 	if (!bSuccess)
  ...
  //    oc_i2c_uninit(I2C_OPENCORES_CAMERA_BASE);  // Release I2C bus , due to
  //    two I2C master shared!
...
int hsv[3];      // hue,saturation,value
int color[5][3]; // red, pink, yellow, green, blue
...
int main() {
  ...
  // //Don't know why this doesn't work - definition is in system.h in BSP
